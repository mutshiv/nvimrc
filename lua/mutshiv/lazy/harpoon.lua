return {
	...
	config = function()
            ...
            vim.keymap.set("n", "<leader>a", function() harpoon:list():add() end, {desc = "Harpoon Mark-f"})
            vim.keymap.set("n", "<leader>h", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end, {desc = "Harpoon Marked Files"})
